...
public class Repository{
    ...
    public List<Stock> setRawdataToList(String path){
        ...
        return setListToStocklist(rawFilelist);
    }
    ...
    public void checkAllStock(String rawTicker, String rawProductName, String rawMarket, String rawSharesissued){
        ...
        if(!vali.checkRegexValidation(rawTicker, "^[0-9][ACDFGHJKLMNPRSTUWXY0-9][0-9][ACDFGHJKLMNPRSTUWXY0-9]$") && vali.checkRegexValidation(rawProductName, "^[A-Za-z0-9()\\.\s]$") && vali.checkMarketValidation(rawMarket) && vali.checkRegexValidation(rawSharesissued, "^[0-9]{1,12}$")){
