...
public class View {
    ...
    public void printSeparatorForStock(){
        System.out.print("-".repeat(TICKER_WIDTH+3));
        System.out.print("+");
        System.out.print("-".repeat(PRODUCTNAME_WIDTH+2));
        System.out.print("+");
        System.out.print("-".repeat(MARKET_WIDTH+2));
        System.out.print("+");
        System.out.print("-".repeat(SHARESISSUED_WIDTH+2));
        System.out.println("");
    }
